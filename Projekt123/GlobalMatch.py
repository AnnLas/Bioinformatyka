...
class GlobalMatch:
    ...
    def mark_path(self, roadMatrix, matrix, sequence1, sequence2):
        ...
        while i > 0 and j > 0:
            ...
            if roadMatrix[j][i] == GlobalMatch.ACROSS:
                i -= 1
                j -= 1
            ...
            elif roadMatrix[j][i] == GlobalMatch.UP:
                j -= 1
                seq1 = seq1 + "-"
                seq2 = seq2 + sequence2[j]
                self.sim += " "

            elif roadMatrix[j][i] == GlobalMatch.LEFT:
                i -= 1
                seq1 = seq1 + sequence1[i]
                seq2 = seq2 + "-"
                self.sim += " "
    ...
    def get_stats(self):
        ...
        statistics += "# Mismatch: " + str(self.mismatch) + '\n'
